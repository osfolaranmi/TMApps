...
<html lang="en">
  <head>
    ...
    <title>Task Manager | Create Account</title>
...
-->            </div>
  ...
  <input class="mdl-textfield__input" type="text" id="fname" pattern="[A-Z,a-z, ]*" required="required" name="fname" />
  <label class="mdl-textfield__label" for="fname">Full name</label>
  <span class="mdl-textfield__error">Letters and spaces only</span>
</div>
  <br> 
  <div class="mdl-textfield mdl-js-textfield">
  <input class="mdl-textfield__input" type="text" id="user" pattern="[A-Z,a-z,1-9,]*" required="required" name="username" />
...
<button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" name="register">
  Create Account
</button>

...
$task = $_POST['task'];
	...
	$query = "UPDATE tasktbl SET task = '$task' , task_date = '$task_date'  WHERE task_id = '$task_id'";
	$result = mysql_query($query) or die ("Error in query: " . mysql_error());

	//if a result is returned
	if ($result)
	{
		echo"<script language='javascript'>alert('Task Successfully Updated');window.location.href='view_task.php'</script> ";
...
<?php
   					$query = "SELECT * FROM tasktbl where task_id = '$task_id'";
...
?>
  ...
  <textarea class="mdl-textfield__input" type="text" rows="3" maxrows="6"
   id="task" name="task"><?php echo $mytask;?></textarea>
  
</div>
<br>

<!-- Colored raised button -->
<button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" name="update_task">
 Update Task
</button>
